...
class SmartAgent(base_agent.BaseAgent):
    ...
    def step(self, obs):
        ...
        self.previous_score = { 'mineral_count': playerInformation[0] , 'vispen_count': playerInformation[1], 'scv_count': playerInformation[3] }
        self.previous_gas_count = playerInformation[1]
        self.previous_mineral_count = playerInformation[0]
